...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / PictureInPictureEvent

# Interface: PictureInPictureEvent

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:23906
...
> `readonly` **pictureInPictureWindow**: [`PictureInPictureWindow`](PictureInPictureWindow.md)

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:23912

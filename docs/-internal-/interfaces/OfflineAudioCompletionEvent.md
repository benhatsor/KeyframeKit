...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / OfflineAudioCompletionEvent

# Interface: OfflineAudioCompletionEvent

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:22295
...
> `readonly` **renderedBuffer**: [`AudioBuffer`](AudioBuffer.md)

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:22301

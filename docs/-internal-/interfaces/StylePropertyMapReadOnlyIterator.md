...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / StylePropertyMapReadOnlyIterator

# Interface: StylePropertyMapReadOnlyIterator\<T\>

Defined in: node\_modules/typescript/lib/lib.dom.iterable.d.ts:356
...
Defined in: node\_modules/typescript/lib/lib.dom.iterable.d.ts:357

#### Returns

`StylePropertyMapReadOnlyIterator`\<`T`\>

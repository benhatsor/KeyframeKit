...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / AnimationPlaybackEventInit

# Interface: AnimationPlaybackEventInit

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:86
...
> `optional` **currentTime**: [`CSSNumberish`](../type-aliases/CSSNumberish.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:87

***

### timelineTime?

> `optional` **timelineTime**: [`CSSNumberish`](../type-aliases/CSSNumberish.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:88

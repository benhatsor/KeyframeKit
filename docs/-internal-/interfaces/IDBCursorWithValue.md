...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / IDBCursorWithValue

# Interface: IDBCursorWithValue

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:17985
...
[`IDBCursor`](IDBCursor.md).[`direction`](IDBCursor.md#direction)
...
[`IDBCursor`](IDBCursor.md).[`key`](IDBCursor.md#key)
...
[`IDBCursor`](IDBCursor.md).[`primaryKey`](IDBCursor.md#primarykey)
...
[`IDBCursor`](IDBCursor.md).[`request`](IDBCursor.md#request)
...
[`IDBCursor`](IDBCursor.md).[`source`](IDBCursor.md#source)
...
Defined in: node\_modules/typescript/lib/lib.dom.d.ts:17991
...
[`IDBCursor`](IDBCursor.md).[`advance`](IDBCursor.md#advance)
...
[`IDBCursor`](IDBCursor.md).[`continue`](IDBCursor.md#continue)
...
[`IDBCursor`](IDBCursor.md).[`continuePrimaryKey`](IDBCursor.md#continueprimarykey)
...
[`IDBCursor`](IDBCursor.md).[`delete`](IDBCursor.md#delete)
...
[`IDBCursor`](IDBCursor.md).[`update`](IDBCursor.md#update)

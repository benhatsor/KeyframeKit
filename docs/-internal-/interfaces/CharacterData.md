...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / CharacterData

# Interface: CharacterData

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:7891
...
- [`Node`](Node.md).[`ChildNode`](ChildNode.md).[`NonDocumentTypeChildNode`](NonDocumentTypeChildNode.md)
...
[`NonDocumentTypeChildNode`](NonDocumentTypeChildNode.md).[`nextElementSibling`](NonDocumentTypeChildNode.md#nextelementsibling)
...
[`NonDocumentTypeChildNode`](NonDocumentTypeChildNode.md).[`previousElementSibling`](NonDocumentTypeChildNode.md#previouselementsibling)
...
[`ChildNode`](ChildNode.md).[`after`](ChildNode.md#after)
...
[`ChildNode`](ChildNode.md).[`before`](ChildNode.md#before)
...
[`ChildNode`](ChildNode.md).[`remove`](ChildNode.md#remove)
...
[`ChildNode`](ChildNode.md).[`replaceWith`](ChildNode.md#replacewith)

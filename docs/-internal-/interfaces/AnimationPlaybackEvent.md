...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / AnimationPlaybackEvent

# Interface: AnimationPlaybackEvent

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:3143
...
> `readonly` **currentTime**: [`CSSNumberish`](../type-aliases/CSSNumberish.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:3149
...
> `readonly` **timelineTime**: [`CSSNumberish`](../type-aliases/CSSNumberish.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:3155

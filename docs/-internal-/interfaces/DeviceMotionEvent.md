...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / DeviceMotionEvent

# Interface: DeviceMotionEvent

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:9628
...
> `readonly` **acceleration**: [`DeviceMotionEventAcceleration`](DeviceMotionEventAcceleration.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:9634
...
> `readonly` **accelerationIncludingGravity**: [`DeviceMotionEventAcceleration`](DeviceMotionEventAcceleration.md) \| `null`
...
Defined in: node\_modules/typescript/lib/lib.dom.d.ts:9646
...
> `readonly` **rotationRate**: [`DeviceMotionEventRotationRate`](DeviceMotionEventRotationRate.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:9652

...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / AudioProcessingEvent

# ~~Interface: AudioProcessingEvent~~

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:3912
...
> `readonly` **inputBuffer**: [`AudioBuffer`](AudioBuffer.md)

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:3919
...
> `readonly` **outputBuffer**: [`AudioBuffer`](AudioBuffer.md)

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:3926
...
Defined in: node\_modules/typescript/lib/lib.dom.d.ts:3933

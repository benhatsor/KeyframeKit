...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / HTMLSlotElement
...
...([`Element`](Element.md) \| [`Text`](Text.md))[]
...
> **assignedElements**(`options?`): [`Element`](Element.md)[]
...
[`AssignedNodesOptions`](AssignedNodesOptions.md)
...
> **assignedNodes**(`options?`): [`Node`](Node.md)[]

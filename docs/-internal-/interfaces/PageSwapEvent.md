...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / PageSwapEvent

# Interface: PageSwapEvent

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:22516
...
> `readonly` **activation**: [`NavigationActivation`](NavigationActivation.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:22522
...
> `readonly` **viewTransition**: [`ViewTransition`](ViewTransition.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:22528

...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / CookieChangeEvent

# Interface: CookieChangeEvent

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:8235
...
> `readonly` **changed**: readonly [`CookieListItem`](CookieListItem.md)[]

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:8241
...
> `readonly` **deleted**: readonly [`CookieListItem`](CookieListItem.md)[]

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:8247

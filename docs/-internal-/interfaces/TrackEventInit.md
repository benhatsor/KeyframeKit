...
[KeyframeKit.js](../../globals.md) / [\<internal\>](../README.md) / TrackEventInit

# Interface: TrackEventInit

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:2283
...
> `optional` **track**: [`TextTrack`](TextTrack.md) \| `null`

Defined in: node\_modules/typescript/lib/lib.dom.d.ts:2284
